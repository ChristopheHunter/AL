...
import top.forfuture.al.activities.AccountActivity;
...
import top.forfuture.al.frags.assist.PermissionsFragment;
...
public class LaunchActivity extends Activity {
    ...
    protected void initData() {
        ...
        // 动画进入到50%,执行Runnable中的run方法，开始尝试获取pushId
