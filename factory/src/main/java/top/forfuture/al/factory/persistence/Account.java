package top.forfuture.al.factory.persistence;
...
import top.forfuture.al.factory.model.db.User_Table;
...
public class Account {
    ...
    public static void load(Context context) {
        ...
        Log.d("TTTT", "pushId:" + pushId);
        Log.d("TTTT", "isBind:" + isBind);
        Log.d("TTTT", "token:" + token);
        Log.d("TTTT", "userId:" + userId);
        Log.d("TTTT", "account:" + account);
    }
